...
# Uses the /releases/latest/download redirect - no GitHub API (avoids rate-limit 403s).
mkdir -p /opt/glance
curl -fL -o /tmp/glance.tar.gz "https://github.com/glanceapp/glance/releases/latest/download/glance-linux-amd64.tar.gz"
