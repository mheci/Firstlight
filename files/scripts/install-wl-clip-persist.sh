...
dnf install -y --nogpgcheck --repofrompath=wlcpp,https://download.copr.fedorainfracloud.org/results/leloubil/wl-clip-persist/fedora-44-x86_64 wl-clip-persist
